...
import { formatCELO, formatPercentage } from "@/utils/formatters";
import {
  ChartBarIcon,
  TrophyIcon,
  BanknotesIcon,
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          ...
          {
            title: "Total Volume",
            value: formatCELO(combined.totalVolume),
      ...
      {creator.totalPools > 0 && (
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="glass-card p-4">
              <div className="text-2xl font-bold text-text-primary mb-1">{formatCELO(creator.avgPoolSize)}</div>
      ...
      {bettor.totalBets > 0 && (
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="glass-card p-4">
              <div className="text-2xl font-bold text-text-primary mb-1">{formatCELO(bettor.totalStaked)}</div>
              <div className="text-sm text-text-muted">Total Staked</div>
            </div>
            <div className="glass-card p-4">
              <div className="text-2xl font-bold text-text-primary mb-1">{formatCELO(bettor.avgBetSize)}</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="glass-card p-4">
              <div className={`text-2xl font-bold mb-1 ${oddyssey.profitLoss >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                {oddyssey.profitLoss >= 0 ? '+' : ''}{formatCELO(oddyssey.profitLoss)}
              </div>
                ...
                <div key={cat.category} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-sm font-bold text-text-primary">{formatCELO(cat.volume)}</div>
              ...
              return (
                <div key={month.month} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-sm font-bold text-text-primary">{formatCELO(month.volume)}</div>
