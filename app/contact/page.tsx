  ...
  const contactMethods = [
    {
      ...
      action: "Join Discord",
      href: "https://discord.gg/celopredict",
    ...
    },
    {
      ...
      action: "support@celopredict.com",
      href: "mailto:support@celopredict.com",
      color: "text-blue-400"
    },
    {
        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-secondary max-w-2xl mx-auto">
              Have questions about CeloPredict? We&apos;re here to help. Choose the best way to reach us below.
            </p>
          </div>
            ...
            >
              ...
              <div className="glass-card">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-text-primary mb-1">How do I get started with CeloPredict?</h4>
                  ...
                  <div>
                    ...
                    <p className="text-text-secondary text-sm">CeloPredict supports CELO and PRIX tokens for betting and staking.</p>
                  </div>
                  <div>
