          ...
          <div className="glass-card prose prose-invert max-w-none">
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="text-text-secondary leading-relaxed">
                  The information provided on CeloPredict (&quot;the Platform&quot;) is for general informational purposes only. 
              ...
              <section>
                ...
                <div className="space-y-4">
                  <p className="text-text-secondary leading-relaxed">
                    CeloPredict is not a financial advisor, broker, or investment company. We do not provide investment, 
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-text-secondary leading-relaxed">
                    CeloPredict operates through smart contracts on the Celo blockchain. While our contracts 
                  ...
                  <p className="text-text-secondary leading-relaxed">
                    CeloPredict may include features in beta or experimental stages. These features are provided &quot;as is&quot; 
              ...
              <section>
                ...
                <p className="text-text-secondary leading-relaxed mb-4">
                  ...
                  responsible for ensuring their use of CeloPredict complies with applicable laws in their location.
                </p>
                <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
                  <p className="text-text-secondary">
                    <strong className="text-blue-400">Important:</strong> CeloPredict may not be available or legal in all 
              ...
              <section>
                ...
                <p className="text-text-secondary leading-relaxed">
                  Market data, odds, and predictions displayed on CeloPredict are generated by users and algorithms. 
              ...
              <section>
                ...
                <p className="text-text-secondary leading-relaxed">
                  CeloPredict may contain links to third-party websites or integrate with external services. We are not 
              ...
              <section>
                ...
                <p className="text-text-secondary leading-relaxed">
                  IN NO EVENT SHALL CELOPREDICT, ITS DEVELOPERS, OR AFFILIATES BE LIABLE FOR ANY DIRECT, INDIRECT, 
