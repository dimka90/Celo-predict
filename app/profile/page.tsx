...
export default function ProfilePage() {
  ...
  const userData = {
    stats: profile?.stats ? {
      ...
      biggestWin: profile.stats.biggestWin.toFixed(2) + " CELO",
      ...
      winRate: "0%",
      profitLoss: "0 CELO",
      averageBetSize: "0 CELO",
      biggestWin: "0 CELO",
      totalVolume: "0 CELO",
      creatorVolume: "0 CELO",
      bettorVolume: "0 CELO",
      lastBetDate: "N/A"
    },
    achievements: badgeData?.active ? badgeData.active.map(badge => ({
      ...
      { 
        ...
        description: "Welcome to CeloPredict!", 
        icon: "FaBolt", 
        date: "Now",
        rarity: "common",
        category: "General"
    ...
    recentActivity: profile?.recentActivity ? profile.recentActivity.slice(0, 4).map(activity => ({
    ...
    })) : [
      {
        id: 1,
        type: "bet_placed",
        description: "Welcome to CeloPredict! Start predicting to see your activity here.",
        amount: null,
        date: "Now"
      }
    ],
