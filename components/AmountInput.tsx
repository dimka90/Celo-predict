...
const AmountInput: React.FC<AmountInputProps> = ({
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      `}>
        ...
        <input
          ...
          className={`
            ...
            ${icon ? 'pl-10' : 'pl-8'}
            ${showMaxButton || currency ? 'pr-28 sm:pr-20' : 'pr-8'}
      ...
      {!disabled && (
        <div className="grid grid-cols-3 gap-2 mt-2 sm:flex sm:flex-wrap">
          {[1, 5, 10, 25, 50, 100].map((amount) => (
            <motion.button
              ...
              className="px-2 py-1.5 text-xs bg-gray-700 hover:bg-gray-600 text-gray-300 hover:text-white rounded-md transition-colors font-medium"
            >
              {amount}
            </motion.button>
          ))}
